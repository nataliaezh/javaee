...
//Создаем сущности - объекты, кот хранятся в БД, а не в памяти JAVA
//Она entity означает, что этот класс-сущность, кот будет хранится в таблице
@Entity
...
public class Product {
    ...
    @Id
    //далее - указание способа генерации ID. Identity значит, что значения будет генерировать сам sql
