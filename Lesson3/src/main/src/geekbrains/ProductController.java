...
import geekbrains.persist.Cart;
...
public class ProductController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            } else if(req.getContextPath().equals("/addToCart")){
                addToCart(req, resp);
            }
    ...
    private void showEditProductPage(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        getServletContext().getRequestDispatcher("/product_edit.jsp").forward(req, resp);
    }
     ...
     //   String action=req.getParameter("action");
      ...
      //  if(action.equals("/addToCart")){
            ...
            List<OrderItem> cart = (List<OrderItem>) session.getAttribute("cart");
                ...
                cart.add(new OrderItem(productRepository.findById(Long.parseLong(req.getParameter("id")))));
            try {
